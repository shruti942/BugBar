...
<h4>
<form method="get" action="UpdateProjectStart">
<ul class="ref">
...
Project Date</td><td><input type="date" name="date" value="date"></td></tr><tr><td>
...
try{
	...
	PreparedStatement ps=con.prepareStatement("update bugproject set date=? where id=?");    
	out.println("suc");	 
	ps.setInt(2, id);
