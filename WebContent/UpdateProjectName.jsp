...
Project Name</td><td><input type="text" name="Desc" value="Description"></td></tr><tr><td>
...
try{
	...
	String desc=request.getParameter("Desc");
		 	PreparedStatement ps=con.prepareStatement("update bugproject set name= ? where id= ?");    
		 	ps.setInt(2, id);
			ps.setString(1, desc);	
