...
Project Description</td><td><input type="text" name="pname" value="name"></td></tr><tr><td>
...
try{
	...
	String desc=request.getParameter("desc");
		 	PreparedStatement ps=con.prepareStatement("update bugproject set desciption=? where id=?");    
		 	ps.setInt(2, id);
			ps.setString(1, desc);
